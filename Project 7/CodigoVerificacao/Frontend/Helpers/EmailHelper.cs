...
namespace TVPlayerSite.Helpers
{
    public class EmailHelper
    {
        ...
        public bool EnviarEmailDemonstracaoExistente(string path, Usuario usuario)
        {
        ...
        public bool EnviarEmailNewsletter(Newsletter newsletter)
        {
            ...
            try
            {
                ...
                SmtpTVPlayer.Send(MailTVPlayer(
                        mailReplyToList:
                            new List<MailAddress> { userMailAddress },
                                mailToList:
                            new List<MailAddress> { contatoMailAddress, new MailAddress("joao.lucas@tvplayer.com.br")},
                                mailBccList:
        ...
        /// </summary>
        public (bool sucesso, string erro) EnviarEmailDemonstracaoExistenteComDetalhes(string path, Usuario usuario)
        {
            try
            {
